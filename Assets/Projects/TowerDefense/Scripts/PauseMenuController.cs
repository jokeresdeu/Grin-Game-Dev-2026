...
{
    /// <summary>
    /// Esc toggles pause; the panel shows whenever the game is Paused. Buttons: Resume,
    /// Restart, Main menu, Quit. Uses the TrySubscribe retry pattern from OrbitGunner so it
    /// never misses the GameManager state event.
    /// </summary>
