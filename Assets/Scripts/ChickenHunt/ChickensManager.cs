...
namespace ChickenHunt
{
    public class ChickensManager : MonoBehaviour
    {
        ...
        [Header("Animations")]
        [SerializeField] private Animator _heartAnimator; // Аніматор сердечка
        [SerializeField] private Animator _gameOverAnimator; // Аніматор панелі Game Over
        ...
        public void TakeDamage(int damage)
        {
            ...
            {
                _heartAnimator.SetTrigger("Hurt");
            }
        ...
        private void GameOver()
        {
            ...
            {
                _finalScoreText.text = $"YOUR SCORE: {_score}";
            }
            ...
            // Запускаємо анімацію появи панелі через тригер "Show"
