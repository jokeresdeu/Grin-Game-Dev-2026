...
namespace ClassicPlatformer
{
    ...
    public class Player : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (!_verticalMovementEnabled && Input.GetButtonDown("Jump") && _isGrounded)
            {
                Jump();
            }
        ...
        {
            float velocityX = _horizontalInput * _moveSpeed;
            float velocityY = _verticalMovementEnabled ? _verticalInput * _climbSpeed : _rb.linearVelocity.y;
